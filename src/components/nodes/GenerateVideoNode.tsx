        ...
        <div className="relative">
          ...
          {isRunning ? (
            ...
            <a
              ...
              className="flex items-center gap-1.5 rounded-lg border border-indigo-200 bg-indigo-50 px-3 py-2 text-[12px] font-medium text-indigo-700 hover:bg-indigo-100"
            >
